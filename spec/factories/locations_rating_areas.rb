FactoryBot.define do
  factory :locations_rating_area, class: '::Locations::RatingArea' do
    ...
    county_zip_ids { [create(:benefit_markets_locations_county_zip, county_name: 'Middlesex', zip: '20024', state: Registry['enterprise.dchbx.primary.production.state_abbr']).id] }
  end
end
