...
RSpec.describe Operations::HraDefaultResultsSetter, type: :model, dbclean: :after_each do
  ...
  context 'for call' do
    ...
    it 'should return HraResults object' do
      expect(@result).to be_a ::HraResults
    end
  end
end
